...
class global_tool : public core::singleton<global_tool>
{
    using singleton_ = core::singleton<global_tool>;
    friend singleton_;

    global_tool() {}
};

class global_text : public core::singleton<global_text>
{
    using singleton_ = core::singleton<global_text>;
    friend singleton_;
