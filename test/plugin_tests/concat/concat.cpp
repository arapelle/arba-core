...
ARBA_CORE_REGISTER_PLUGIN_FUNCTION(make_unique_instance_from_args)
ARBA_CORE_REGISTER_PLUGIN_FUNCTION(make_shared_instance)
ARBA_CORE_REGISTER_PLUGIN_FUNCTION(make_shared_instance_from_args)
ARBA_CORE_REGISTER_PLUGIN_FUNCTION(execute)
ARBA_CORE_REGISTER_PLUGIN_FUNCTION(default_concat)
ARBA_CORE_REGISTER_PLUGIN_FUNCTION(default_const_concat)
ARBA_CORE_END_PLUGIN_FUNCTION_REGISTER()
