...
public:
     ...
     * @param getter_function_name The name of the global variable getter function to find in the plugin. (default is
     * "instance_ref")
     ...
     * @tparam DeleterType The type of the deleter functor used by std::unique_ptr. (default is
     * std::unique_ptr<ClassType>::deleter_type>)
    ...
    std::unique_ptr<ClassType, DeleterType>
     ...
     * @tparam ClassType The type of the made instance.
     * @param maker_function_name The name of the maker function to find in the plugin. (default is
