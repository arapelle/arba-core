...
{
    using tokenizer_function = core::char_tokenizer<char>;
    using string_view_token_iterator = core::string_view_token_iterator<tokenizer_function, char>;
...
{
    std::string_view str("Some beautiful text");
    core::string_view_tokenizer str_tokens(str, ' ');
...
{
    std::string_view str("Some beautiful,text");
    core::string_view_tokenizer str_tokens(str, std::string_view(" ,"));
...
TEST(string_view_tokenizer_tests, test_tokenizer_char_set_str)
{
    std::string_view str("Some beautiful,text");
    std::string seps(" ,");
    core::string_view_tokenizer str_tokens(str, seps);
...
{
    std::string_view str("Some   beautiful\ttext");
    core::string_view_tokenizer str_tokens(str, isspace);
...
{
    using tokenizer_function = core::char_tokenizer<char>;
    using string_token_iterator = core::string_token_iterator<tokenizer_function, char>;
...
{
    std::string_view str("Some beautiful text");
    core::string_tokenizer str_tokens(str, ' ');
...
{
    std::string_view str("Some beautiful,text");
    core::string_tokenizer str_tokens(str, std::string_view(" ,"));
...
TEST(string_tokenizer_tests, test_tokenizer_char_set_str)
{
    std::string_view str("Some beautiful,text");
    std::string seps(" ,");
    core::string_tokenizer str_tokens(str, seps);
...
{
    std::string_view str("Some   beautiful\ttext");
    core::string_tokenizer str_tokens(str, isspace);
