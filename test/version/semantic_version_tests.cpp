...
TEST(semantic_version_tests, semantic_version_constructor__sv__no_exception)
{
    ...
    ASSERT_EQ(version_1.pre_release(), "0.0");
    ...
    ASSERT_EQ(version_2.pre_release(), "15.25");
    ...
    ASSERT_EQ(version_3.pre_release(), "alpha.beta");
    ...
    ASSERT_EQ(version_4.pre_release(), "");
...
TEST(semantic_version_tests, operator_lt__normal__no_exception)
{
    ...
    EXPECT_TRUE(core::semantic_version("1.2.3-alpha.1") < core::semantic_version("1.2.3-alpha.2"));
