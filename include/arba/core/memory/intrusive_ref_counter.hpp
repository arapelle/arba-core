...
private:
    ...
    template <unsigned counter_bitsize, thread_policy th_policy>
        requires (sizeof(make_integer_t<counter_bitsize, unsigned, th_policy>) <= 8)
    friend class intrusive_ref_counter;

    template <unsigned counter_bitsize, thread_policy th_policy>
        requires (sizeof(make_integer_t<counter_bitsize, unsigned, th_policy>) < 8
                 || std::is_same_v<th_policy, thread_unsafe_t>)
    friend class intrusive_ref_counters;
};

template <unsigned counter_bitsize = 32, thread_policy th_policy = thread_safe_t>
    requires (sizeof(make_integer_t<counter_bitsize, unsigned, th_policy>) <= 8)
...
class intrusive_ref_counter<counter_bitsize, thread_safe_t> : public intrusive_type_base
{
private:
    using atomic_ref_counter_type = make_integer_t<counter_bitsize, unsigned, thread_safe_t>;
...
template <unsigned counter_bitsize>
class intrusive_ref_counter<counter_bitsize, thread_unsafe_t> : public intrusive_type_base
{
private:
    using ref_counter_type = make_integer_t<counter_bitsize, unsigned>;
...
template <unsigned counter_bitsize>
class intrusive_ref_counters<counter_bitsize, thread_unsafe_t>
    : public intrusive_ref_counter<counter_bitsize, thread_unsafe_t>
{
private:
    using ref_counter_type = make_integer_t<counter_bitsize, unsigned>;
...
public:
    ...
    {
        return intrusive_ref_counter<counter_bitsize, thread_unsafe_t>::decrement_use_counter(ptr)
...
template <unsigned counter_bitsize>
class intrusive_ref_counters<counter_bitsize, thread_safe_t> : public intrusive_type_base
{
private:
    using atomic_ref_counter_type = make_integer_t<counter_bitsize * 2, unsigned, thread_safe_t>;
    using ref_counter_type = typename atomic_ref_counter_type::value_type;
    static constexpr ref_counter_type use_count_mask = make_integer_t<counter_bitsize, unsigned>(~0);
