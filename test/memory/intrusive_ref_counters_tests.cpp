...
class intrusive_ref_counters : public core::intrusive_ref_counters<counter_bitsize, th_policy>
{
private:
    using base_ = core::intrusive_ref_counters<counter_bitsize, th_policy>;
...
struct ircnts_tests
{
    ...
    static void test_ircnts_copy()
    {
        ...
        core::intrusive_shared_ptr_add_ref(ircnts_ptr_2);
        core::intrusive_weak_ptr_add_ref(ircnts_ptr_2);
        core::intrusive_shared_ptr_release(ircnts_ptr_2);
        ASSERT_TRUE(valid_2);
        core::intrusive_weak_ptr_release(ircnts_ptr_2);
        ASSERT_TRUE(valid);
