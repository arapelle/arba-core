...
[[nodiscard]] constexpr bool extract_tri_version_(std::string_view::const_iterator& iter,
...
[[nodiscard]] constexpr bool extract_tri_version_(std::string_view version, std::string_view& major,
                                                  std::string_view& minor, std::string_view& patch)
{
