...
TEST(format_time_point_tests, test_format_filename)
{
    ...
    ASSERT_EQ(core::format_filename_Ymd_HMS(time_point), "20140109_123534");
    ASSERT_EQ(core::format_filename_Ymd_HMS_ms(time_point), "20140109_123534_000");
    ASSERT_EQ(core::format_filename_Ymd_HMS_mcs(time_point), "20140109_123534_000000");

    time_point = make_time_point("2014/01/09 12:35:34", 123);
    ASSERT_EQ(core::format_filename_Ymd_HMS(time_point), "20140109_123534");
    ASSERT_EQ(core::format_filename_Ymd_HMS_ms(time_point), "20140109_123534_123");
    ASSERT_EQ(core::format_filename_Ymd_HMS_mcs(time_point), "20140109_123534_123000");

    time_point = make_time_point("2014/01/09 12:35:34", 123, 786);
    ASSERT_EQ(core::format_filename_Ymd_HMS(time_point), "20140109_123534");
    ASSERT_EQ(core::format_filename_Ymd_HMS_ms(time_point), "20140109_123534_123");
    ASSERT_EQ(core::format_filename_Ymd_HMS_mcs(time_point), "20140109_123534_123786");
}
...
TEST(format_time_point_tests, test_format_log)
{
    ...
    ASSERT_EQ(core::format_log_Ymd_HMS_ms(time_point), "2014-01-09 12:35:34.000");
    ASSERT_EQ(core::format_log_Ymd_HMS_mcs(time_point), "2014-01-09 12:35:34.000000");
    ...
    ASSERT_EQ(core::format_log_Ymd_HMS(time_point), "2014-01-09 12:35:34");
    ASSERT_EQ(core::format_log_Ymd_HMS_ms(time_point), "2014-01-09 12:35:34.123");
    ASSERT_EQ(core::format_log_Ymd_HMS_mcs(time_point), "2014-01-09 12:35:34.123786");
}
