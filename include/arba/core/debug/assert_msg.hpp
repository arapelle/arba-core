...
template <class... Args>
inline void print_assert_failed_(const char* expr_str, const char* file, int line, std::format_string<Args...> fmt, Args&&... args)
{
...
(void) \
    (static_cast<bool>(bexpr__) || \
     (::arba::core::private_::print_assert_failed_((#bexpr__),(__FILE__),(__LINE__),(msg__)__VA_OPT__(,)__VA_ARGS__),ARBA_BREAKPOINT(),std::abort(),0))
