...
class simple_version_tag
{
public:
    using tuple_type = std::tuple<uint64_t, uint32_t, uint32_t>;

    constexpr simple_version_tag() = default;
    ...
    inline constexpr auto operator==(const simple_version_tag<OtherMajor, OtherMinor, OtherPatch>& other) const noexcept
    {
