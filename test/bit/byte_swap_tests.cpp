...
{
    int64_t value = -1'152'921'504'606'846'977;
...
{
    Value_16 = 0xaabb,
    Swapped_value_16 = 0xbbaa
};
enum enum_u32 : uint32_t
{
    Value_32 = 0xaabbccdd,
    Swapped_value_32 = 0xddccbbaa
};
enum enum_u64 : uint64_t
{
    Value_64 = 0x1122334455667788,
    Swapped_value_64 = 0x8877665544332211
};
