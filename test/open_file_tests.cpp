...
TEST(core_tests, test_open_input_file)
{
    try
    {
...
TEST(core_tests, test_open_input_file_exception_file_not_found)
{
    try
    {
...
TEST(core_tests, test_open_input_file_exception_not_regular_file)
{
    try
    {
