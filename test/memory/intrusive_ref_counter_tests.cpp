...
class intrusive_ref_counter : public core::intrusive_ref_counter<counter_bitsize, th_policy>
{
private:
    using base_ = core::intrusive_ref_counter<counter_bitsize, th_policy>;
...
struct ircnt_tests
{
    static void test_ircnt()
    {
        ...
        core::intrusive_shared_ptr_add_ref(ircnt_ptr);
        ASSERT_EQ(ircnt_ptr->use_count(), 1);
        core::intrusive_shared_ptr_add_ref(ircnt_ptr);
        ASSERT_EQ(ircnt_ptr->use_count(), 2);
        core::intrusive_shared_ptr_release(ircnt_ptr);
        ASSERT_TRUE(valid);
        ASSERT_EQ(ircnt_ptr->use_count(), 1);
        core::intrusive_shared_ptr_release(ircnt_ptr);
        ASSERT_FALSE(valid);
    ...
    static void test_ircnt_copy()
    {
        ...
        core::intrusive_shared_ptr_add_ref(ircnt_ptr_2);
        core::intrusive_shared_ptr_release(ircnt_ptr_2);
        ASSERT_TRUE(valid);
